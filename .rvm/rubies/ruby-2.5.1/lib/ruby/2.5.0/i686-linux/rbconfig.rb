...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.5.0/i686-linux")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/vagrant/.rvm/rubies/ruby-2.5.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/vagrant/.rvm/rubies/ruby-2.5.1' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/vagrant/.rvm/rubies/ruby-2.5.1"
